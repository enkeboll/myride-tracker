...
def is_bus_active_time(dt: datetime = None, ignore_schedule: bool = None) -> bool:
    ...
    Monday through Friday, 7:45 AM to 9:15 AM Eastern Time (ET).
    """
...
def get_active_window_info(dt: datetime = None) -> tuple[bool, str, str]:
    ...
    if is_active:
        msg = "Active window (Mon-Fri 7:45 AM - 9:15 AM ET)"
    elif now.weekday() > 4:
        msg = "Off-hours (Weekend - Bus inactive)"
    else:
        msg = "Off-hours (Mon-Fri active window is 7:45 AM - 9:15 AM ET)"
